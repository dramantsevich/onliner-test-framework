...
public class ProductPage {
    ...
    @FindBy(xpath = "//a[@class='button button_orange button_big offers-description__button']")
    private WebElement offersButton;

    @FindBy(xpath = "//div[@class='offers-filter__flex']")
    private WebElement offersFilter;

    @FindBy(xpath = "//a[@class='button-style button-style_base-alter offers-list__button offers-list__button_cart button-style_another']")
    ...
    public WebElement getOffersListItemByNumber(String itemNumber){
        return driver.findElement(By.xpath("//div[contains(@class, 'offers-list__item')]["+ itemNumber +"]" +
                "//a[@class='button-style button-style_base-alter offers-list__button offers-list__button_cart button-style_expletive']"));
    }
